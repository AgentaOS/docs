...
<Note>
  This is an **optional, legacy** flow for a self-custody EUR IBAN in your company's name. You don't need it to get paid: your standard payout account already receives **EUR and USD** through our banking partner (EUR to a EUR account, USD to a USD account). See [Payouts](/payouts/overview).
</Note>
