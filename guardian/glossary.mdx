---
title: "Glossary"
description: "Key terms used in AgentaOS: threshold signing, MPC, DKG, ECDSA, shares, guardrails, and more. Plain-language definitions."
"og:title": "Glossary — AgentaOS"
"og:description": "Plain-language definitions of threshold signing, MPC, DKG, ECDSA, shares, guardrails, Vault, and other AgentaOS concepts."
---
...
A way to sign transactions where multiple parties must cooperate. No single party can sign alone. Agenta uses 2-of-3 threshold signing: three shares exist, any two can produce a valid signature.
...
The threshold signing protocol used by Agenta. Named after its creators (Canetti, Gennaro, Goldfeder, Makriyannis, Peled). It splits ECDSA key generation and signing into a multi-party protocol where no party ever sees the full key.
