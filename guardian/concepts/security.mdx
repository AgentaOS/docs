...
description: "How AgentaOS protects agent accounts. Share isolation, memory wiping, browser-side decryption, API key hashing, and a comprehensive threat model."
"og:title": "Security Model — AgentaOS"
"og:description": "AgentaOS security model: shares stored separately, wiped from memory after use, browser-side decryption, and zero key reconstruction paths."
---
...
Found a vulnerability? Email **security@agentaos.ai**. We take every report seriously.
