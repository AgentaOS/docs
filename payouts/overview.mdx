...
<CardGroup cols={2}>
  <Card title="Incoming" icon="clock">
...
```mermaid
flowchart LR
  A[Buyer pays<br/>card, bank, or stablecoin] --> B[Incoming<br/>clearing ~14 days]
  B --> C[Available]
...
<CardGroup cols={1}>
  <Card title="Stablecoin payouts (experimental)" icon="wallet" href="/experimental/stablecoin-payouts">
