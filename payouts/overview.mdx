...
<CardGroup cols={2}>
  ...
  <Card title="Activate a EUR account (self-custody IBAN)" icon="building" href="/banking/activate-eur">
    An optional legacy flow that provisions a EUR IBAN in your own name. Most merchants don't need it, bank payouts already reach your account through our banking partner.
  </Card>
</CardGroup>
