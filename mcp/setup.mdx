---
title: MCP Server
description: Connect AI agents to AgentaOS via MCP.
---

The AgentaOS MCP server exposes your account to any Model Context Protocol client, so an AI agent can create checkouts, read customers and subscriptions, send receipts, and operate your wallet on your behalf. Use it when you want Claude Desktop, Cursor, or Windsurf to run AgentaOS directly, instead of calling the API or CLI by hand.
