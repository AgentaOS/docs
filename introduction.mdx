...
<Card title="Building with an agent? Hand it the docs." icon="robot" href="/agents/overview">
...
<CardGroup cols={2}>
  <Card title="Add a payment link" icon="link" href="/payments/payment-links">
    A shareable URL you can charge many times. No code to share it.
  </Card>
  <Card title="Sell a subscription" icon="rotate" href="/guides/sell-a-subscription">
    Recurring billing with automatic renewals and tax handled.
  </Card>
  <Card title="Bill a client" icon="file-invoice" href="/payments/invoices">
    Send a tax-correct invoice, paid on the same secure checkout.
  </Card>
  <Card title="Let your agent run it" icon="wand-magic-sparkles" href="/agents/overview">
    Point Claude or Cursor at AgentaOS and let it operate the store.
  </Card>
</CardGroup>

## What is AgentaOS?

AgentaOS is the billing and payments platform for AI founders, and a **Merchant of Record**. That means we become the legal seller of your product: your buyer pays AgentaOS, and we handle the payment, the VAT, the invoice, and the payout to you. You never register for tax abroad, file a cross-border return, or reconcile three processors. As the registered seller of record we carry the payment and tax liability, not you, and we are PCI-compliant and bank-grade secure. See [How it works](/mor/how-it-works).
...
<AccordionGroup>
  ...
  <Accordion title="Can my AI agents manage my store?">
