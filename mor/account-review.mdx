...
<Frame caption="The Go live tracker: run a test payment, verify your business, then add a payout account.">
  <img src="/images/product/go-live.png" alt="Go live checklist with Verify your business in review" />
</Frame>
