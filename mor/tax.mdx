...
<CardGroup cols={2}>
  ...
  <Card title="United Kingdom" icon="landmark">
    Destination VAT, registered directly.
  </Card>
</CardGroup>

<Note>
We calculate VAT for the jurisdictions where we are registered today, the EU (via Estonia OSS) and the UK, and add more as we grow.
</Note>
