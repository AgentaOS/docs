...
```mermaid
flowchart LR
    A[Buyer pays<br/>card, bank, or stablecoin] --> B[AgentaOS is seller of record<br/>Estonia]
...
<Steps>
  <Step title="Buyer pays">
    Your customer checks out by card, bank transfer, or stablecoin. They see AgentaOS as the seller on the payment page and the receipt.
  </Step>
  ...
  <Step title="You pay out">
    Move your balance to your bank account (SEPA) or your wallet, on your schedule. See [Payouts](/payouts/overview).
  </Step>
</Steps>
