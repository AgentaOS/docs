...
description: "Use AgentaOS as a signer for Forge scripts, Cast commands, and Hardhat deployments. No private keys in your environment."
"og:title": "Foundry Integration — AgentaOS"
"og:description": "Deploy smart contracts with threshold signing. Agenta's JSON-RPC proxy works with Forge, Cast, and Hardhat. No private keys needed."
---
