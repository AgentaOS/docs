...
<ParamField body="linkId" type="string">
  `paymentLinks.id`. On the product page this is **Copy link ID**. The session inherits the link's amount, currency, and description. Omit for a standalone checkout.
</ParamField>
