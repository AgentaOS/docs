...
<Steps>
  ...
  <Step title="Add a payout account">
    ...
    <Tabs>
      <Tab title="Bank (SEPA)">
        Get a real European IBAN linked to your AgentaOS balance.
...
- Optionally, run one small real checkout end to end: create it with your live key, pay it with a real card or bank transfer, and confirm it lands in **Finance → Payments** with an invoice under **Finance → Invoices**. Unlike test mode, live mode doesn't accept the `4242...` test card, only real payment methods clear.
