...
description: "Point a coding agent at the SKILL.md prompt, or connect the MCP server, so an AI agent can create checkouts, check status, and manage subscriptions for you."
---
